...
function SearchKeywordDetails ({ className = '', onClear, outcome: { from, message, output, params, result, when } }: Props): React.ReactElement<Props> | null {
...
`;
export default React.memo(SearchKeywordDetails);
