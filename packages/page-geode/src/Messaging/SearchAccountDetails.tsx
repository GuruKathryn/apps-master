...
function SearchAccountDetails ({ className = '', onClear, outcome: { from, message, output, params, result, when } }: Props): React.ReactElement<Props> | null {
      ...
      try {
        ...
        return(
          ...
          <Table.Header>
            <Table.Row>
              <Table.HeaderCell>
                {t<string>(' Total InBox: ')}{countInbox}{' '}
                {t<string>(' Total Lists: ')}{countLists}{' '}
                {t<string>(' Total Groups: ')}{countGroups}{' '}
                {inBoxDetail.ok.search && (<>
                  <h3>
                      <strong>{t<string>(' Search Results for Account: ')}</strong>
          ...
          <Table.Row>
            ...
            <h2><LabelHelp help={t<string>(' This is your Inbox. Send messages to people directly by clicking on the blue envelop icon. ')} />
                <strong>{t<string>(' People: ')}</strong>
                  ...
                  {_people.message.length>0 && 
                      (<>
                          <Expander 
                            className='message'
                            isOpen={false}
                            summary={<Label size={'small'} color='orange' circular> {t<string>('Messages ✉️')}</Label>}>                  
          ...
          <Table.Row>
            <Table.Cell verticalAlign='top'>
            <h2><LabelHelp help={t<string>(' This is your subscribed Lists. ')} />
                <strong>{t<string>(' Lists: ')}</strong>
          ...
          <Table.Row>
            <Table.Cell verticalAlign='top'>
            <h2><LabelHelp help={t<string>(' These are your public and private Groups. Send a message to the Group by clicking the blue envelop icon. ')} />
                <strong>{t<string>(' Groups: ')}</strong>
