...
function GotoStoreDetails ({ className = '', onClear, isAccount, outcome: { from, message, output, params, result, when } }: Props): React.ReactElement<Props> | null {
          ...
          <Table.Header>
            <Table.Row>
              ...
              <Grid columns={2} divided>
                ...
                <Grid.Column>
                <h2>
                    {t<string>('Reviews from Buyers: ')}{profileDetail.ok.owner.reviews.length}<br />
                    {t<string>('Total Orders: ')}{profileDetail.ok.owner.totalOrders}<br />
                    {t<string>('Total Delivered: ')}{profileDetail.ok.owner.totalDelivered}<br />
                    {t<string>('Total Damaged: ')}{profileDetail.ok.owner.totalDamaged}<br />
                    {t<string>('Total Not Received: ')}{profileDetail.ok.owner.totalNotReceived}<br />
                    {t<string>('Total Refused: ')}{profileDetail.ok.owner.totalRefused}<br />
                    {t<string>('Total Resolved: ')}{profileDetail.ok.owner.totalResolved}<br />
                    {t<string>('Total Wrong: ')}{profileDetail.ok.owner.totalWrong}<br />                
                </h2>
                </Grid.Column>
                </Grid.Row>
                </Grid>
