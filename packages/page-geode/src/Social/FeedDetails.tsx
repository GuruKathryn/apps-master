                          ...
                          <Table.Row>
                            <Table.Cell>
                              ...
                              <CopyInline value={_replyFeed.messageId} label={''}/>                                
                                  ...
                                  <br />      
                                  {(_replyFeed.link != '0x') ? (
                              <>{(isHex(_replyFeed.link) ? withHttp(hexToString(_replyFeed.link).trim()) : defaultImage) !='' ? 
                              (<><Image bordered rounded src={(isHex(_replyFeed.link) ? withHttp(hexToString(_replyFeed.link).trim()) : defaultImage)} size='large' />
                              </>) : (
                               <><Image src={defaultImage} size='small'  /></>
                              )}<br />
