...
function ContractsTable ({  contracts: keyringContracts, initMessageIndex, removeAccountID }: Props): React.ReactElement<Props> {
  ...
  const contractAddress: string = (JSONContractAddress[7])? JSONContractAddress[7] :'5HJjHKgw4hupcKizpwyLm5VAK23nm6qEGEaaRrHK9FGsMxj9';
 ...
 return (
    <>
      {!contract && (
        <Card>
          {t<string>('Load The Geode Reporting Smart Contract')}
          <Button
